            ...
            foreach ($infak as $a) : ?>
              <tr>
                ...
                <td class="text-center">
                  <a data-target="#modalHapus" data-toggle="modal" type="button" href="<?= base_url('bendahara/hapus_pengeluaran/' . $a['id_pengajuan']) ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
