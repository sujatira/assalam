...
<div class="row mt-3" style="background-color: darkslategray;">
  <div class="col-sm-8">
    <footer class="text-white">
      <div class="container">
        <h3 class="mt-2" style="color: salmon;">Masjid Jami-Assalam Bojongrangkas</h3>
        <ul>
          <span class="card-text bi bi-geo-alt-fill"><i class="fas fa-map-marker-alt"></i> Jl. Sapan-Majalaya</span><br>
...
<div class="text-white copyright text-center col" style="background-color: black;">
  <a>Copyright &copy; Jami-Assalam 2021 - <?= date('Y'); ?></a>
</div>
